...
conn.reply(m.chat, 'https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *‼️There are still unanswered songs in this chat.‼️*', conn.tebaklagu[id][0])
throw false
...
json, poin,
setTimeout(() => {
if (conn.tebaklagu[id]) conn.reply(m.chat, `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *Time's up!\nThe answer is* ${json.jawaban}`, conn.tebaklagu[id][0])
