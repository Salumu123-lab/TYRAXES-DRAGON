...
let handler = async (m, { conn, args, text, usedPrefix, command }) => {
    if (!args[0]) throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] enter what you want to search* \n\n📌*Example:*\n${usedPrefix + command} homero`
...
🔥 *Title:* ${json.title}
❤️‍🔥 *Total stickers:* ${json.sticker_url.length}
📢 *Estimated shipping time:* _*${json.sticker_url.length * 2} s*_`)
	...
	m.reply(`https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] Error: try another*`)
	} 
}
