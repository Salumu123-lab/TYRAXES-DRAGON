...
let handler = async (m, { text }) => {
  if (!text) throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] Enter a name for your image file and the desired extension (e.g. name.png, name.jpg, etc*.)`;
