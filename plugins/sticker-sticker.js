...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      if (!img) throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q ${tradutor.texto1} ${usedPrefix + command}*`;
      let out;
      try {
      ...
      else return m.reply(`https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q ${tradutor.texto2} ${usedPrefix}s https://i.imgur.com/jQh5iIT.jpeg*`);
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
   ...
   else return m.reply(`https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q ${tradutor.texto3}` + ` ${usedPrefix + command}*`);
  }
};
handler.help = ['sfull'];
